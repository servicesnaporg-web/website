  ...
  return (
    <div className="min-h-screen" style={{backgroundColor: 'var(--warm-beige)'}}>
      ...
      <main>
        ...
        <section className="container mx-auto px-6 py-20" style={{backgroundColor: '#fafafa'}}>

          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-center mb-4" style={{color: '#1e40af', background: 'linear-gradient(to right, #1e40af, #3b82f6)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'}}>ServiceSnap Mobile App</h2>
              <p className="text-xl text-center mb-12 font-medium" style={{color: '#4b5563'}}>Experience seamless service booking on the go</p>
            </div>
            
            <div className="grid lg:grid-cols-3 gap-8 mb-16">
              {/* Browse Services Carousel */}
              <ImageCarousel 
                images={[
                  {
                    src: "/app-screenshot-1.png",
                    alt: "ServiceSnap App - Browse Services Home",
                    title: "Browse Services",
                    description: "Explore a wide range of local service providers"
                  },
                  {
                    src: "/app-screenshot-2.png",
                    alt: "ServiceSnap App - Service Categories",
                    title: "Browse Services",
                    description: "Filter by category, rating, and location"
                  }
                ]}
                autoSwitchInterval={3000}
              />
              
              {/* Easy Booking Carousel */}
              <ImageCarousel 
                images={[
                  {
                    src: "/app-screenshot-booking-1.png",
                    alt: "ServiceSnap App - Select Service",
                    title: "Easy Booking",
                    description: "Choose your desired service and time slot"
                  },
                  {
                    src: "/app-screenshot-booking-2.png",
                    alt: "ServiceSnap App - Booking Confirmation",
                    title: "Easy Booking",
                    description: "Get instant booking confirmation and details"
                  }
                ]}
                autoSwitchInterval={3000}
              />
              
              {/* Authentic Reviews Carousel */}
              <ImageCarousel 
                images={[
                  {
                    src: "/app-screenshot-reviews-1.png",
                    alt: "ServiceSnap App - Read Reviews",
                    title: "Authentic Reviews",
                    description: "Read honest feedback from real customers"
                  },
                  {
                    src: "/app-screenshot-reviews-2.png",
                    alt: "ServiceSnap App - Write Reviews",
                    title: "Authentic Reviews",
                    description: "Share your experience and rate providers"
                  }
                ]}
                autoSwitchInterval={3000}
              />
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <div className="relative">
                  <a 
                    ...
                    className="inline-flex items-center gap-3 bg-black text-white px-6 py-3 rounded-xl font-medium hover:bg-gray-800 transition-colors"
                  >
                  ...
                  {showDownloadMessage && (
                    <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-4 py-2 bg-gray-800 text-white text-sm rounded-lg whitespace-nowrap">
                ...
                <div className="relative">
                  ...
                  >
                    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M3.609 1.814L13.792 12 3.61 22.186a1.757 1.757 0 0 1-.252-.921 1.77 1.77 0 0 1 1.77-1.768h13.84a.89.89 0 0 0 .863-1.108 1.77 1.77 0 0 1-.034-.428c0-.982.693-1.811 1.695-2.043l.011-.002.018-.001a.5.5 0 0 0 .12-.984h-.003l-.01.003c-1.16.13-2.18.906-2.435 2.035a.9.9 0 0 0 .873 1.1h-13.7a.12.12 0 0 0-.12.12v.08c0 .032.008.062.011.093l.001.01v-.002L12 14.5l-9.5 9.5v-20z"/>
                    </svg>
                    <div className="text-left">
      ...
      <footer className="bg-green-800 text-white">
        <div className="container mx-auto px-6 py-12">
          <div className="text-center">
            ...
            <p className="text-green-200 mb-4">© {new Date().getFullYear()} ServiceSnap. Connecting communities, at your convenience.</p>
            <div className="mt-4">
              <a href="mailto:servicesnap.org@gmail.com" className="text-green-300 hover:text-white transition-colors flex items-center justify-center gap-2">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                servicesnap.org@gmail.com
              </a>
            </div>
          </div>
        </div>
